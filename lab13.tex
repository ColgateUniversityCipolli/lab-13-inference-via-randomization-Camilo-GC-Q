...
\hldef{n} \hlkwb{=} \hldef{((}\hlkwd{skewness}\hldef{(further)}\hlopt{/}\hldef{(}\hlnum{6}\hlopt{*}\hlnum{0.1}\hlopt{*}\hlnum{0.05}\hldef{))} \hlopt{*} \hldef{(}\hlnum{2}\hlopt{*}\hldef{t}\hlopt{^}\hlnum{2} \hlopt{+} \hlnum{1}\hldef{)} \hlopt{*} \hlkwd{qt}\hldef{(alpha,} \hlkwc{df} \hldef{= n} \hlopt{-} \hlnum{1}\hldef{))}\hlopt{^}\hlnum{2}
\hldef{n}
\end{alltt}
\begin{verbatim}
## [1] 51901791
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in FUN(X[[i]], ...): argument is missing, with no default}}\end{kframe}
\end{knitrout}
